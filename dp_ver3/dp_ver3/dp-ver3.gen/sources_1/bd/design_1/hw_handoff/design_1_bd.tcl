...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKIN2_JITTER_PS {139.21} \
  ...
  set_property -dict [ list \
   CONFIG.GEN_F0_VBLANK_HEND {0} \
   CONFIG.GEN_F0_VBLANK_HSTART {0} \
   CONFIG.GEN_F0_VFRAME_SIZE {1125} \
   CONFIG.GEN_F0_VSYNC_HEND {0} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_tpg_0_m_axis_video] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS] [get_bd_intf_pins v_tpg_0/m_axis_video]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_tpg_0_m_axis_video]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rst_ps8_0_96M1/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_2/clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk]
  connect_bd_net -net rst_ps8_0_96M1_peripheral_reset [get_bd_pins rst_ps8_0_96M1/peripheral_reset] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net rst_ps8_0_96M_peripheral_reset [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_ps8_0_96M/peripheral_reset]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins system_ila_2/probe1] [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_pixel1]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net vtm_0_o_href [get_bd_pins system_ila_2/probe0] [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins xlconcat_0/In1] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_de]
  connect_bd_net -net vtm_0_o_hstr [get_bd_pins system_ila_2/probe2] [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins xlconcat_0/In2] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_hsync]
  connect_bd_net -net vtm_0_o_vstr [get_bd_pins system_ila_2/probe3] [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins xlconcat_0/In3] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_vsync]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins system_ila_1/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_96M/ext_reset_in] [get_bd_pins rst_ps8_0_96M1/ext_reset_in] [get_bd_pins v_tc_0/resetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_tpg_0/s_axi_CTRL/Reg] -force
